...
const AboutHero = () => {
  ...
  return (
    <section 
      className="relative min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 overflow-hidden flex items-center"
      style={{
        backgroundImage: `
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-left">
            ...
            <div className="relative inline-block mb-8">
              ...
              <div className="relative bg-white/90 backdrop-blur-md border-4 border-orange-300/50 rounded-full px-8 py-4 shadow-2xl">
                <span className="text-orange-600 font-black uppercase tracking-widest text-lg flex items-center gap-3">
            ...
            {/* Revolutionary Title */}
            <h1 className="text-6xl lg:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-600 via-amber-500 to-yellow-500 leading-tight mb-8">
            ...
            <div className="grid grid-cols-3 gap-8 mb-12">
              <div className="text-center">
                <div className="text-4xl lg:text-5xl font-black text-orange-600 mb-2">15+</div>
                <div className="text-gray-600 font-semibold">Years Experience</div>
              </div>
              <div className="text-center">
                <div className="text-4xl lg:text-5xl font-black text-amber-600 mb-2">5000+</div>
                <div className="text-gray-600 font-semibold">Students Trained</div>
              </div>
              <div className="text-center">
                <div className="text-4xl lg:text-5xl font-black text-yellow-600 mb-2">95%</div>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <a
                href="#story"
                className="group px-10 py-5 bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold rounded-2xl hover:from-orange-600 hover:to-amber-600 transition-all duration-500 hover:shadow-2xl hover:scale-105 text-center overflow-hidden transform-gpu"
              >
              ...
              <a
                href="/contact"
                className="group px-10 py-5 bg-white border-4 border-orange-300 text-orange-600 font-bold rounded-2xl hover:bg-orange-50 hover:border-orange-400 transition-all duration-500 hover:shadow-2xl hover:scale-105 text-center"
              >
          ...
          <div className="relative">
            ...
            <div className="relative group">
              {/* Background Glow */}
              <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-amber-400 rounded-3xl blur-2xl opacity-50 group-hover:opacity-75 transition-opacity duration-500 animate-pulse-slow"></div>
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-orange-200/50 transform group-hover:scale-105 transition-all duration-700">
                <div className="aspect-w-16 aspect-h-12 bg-gradient-to-br from-orange-100 to-amber-100 p-12">
                  ...
                  <div className="w-full h-96 bg-gradient-to-br from-orange-200 to-amber-200 rounded-2xl flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <div className="text-2xl font-bold text-orange-700">Trinkets Institute</div>
                      <div className="text-lg text-amber-700">Excellence in Engineering Education</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -top-6 -right-6 bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-2xl px-6 py-4 shadow-2xl animate-bounce-gentle">
                <div className="text-center">
              ...
              <div className="absolute -bottom-6 -left-6 bg-gradient-to-r from-amber-500 to-yellow-500 text-white rounded-2xl px-6 py-4 shadow-2xl animate-bounce-gentle" style={{animationDelay: '0.5s'}}>
                <div className="text-center">
                  <div className="text-2xl font-bold">⭐</div>
