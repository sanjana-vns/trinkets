  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 left-1/3 w-96 h-96 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float"></div>
        <div className="absolute bottom-1/3 right-1/3 w-80 h-80 bg-indigo-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse-slow"></div>
      </div>
      ...
      <div className={`relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 ${
        ...
        <div className="relative">
          <div className="max-w-5xl mx-auto">
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="relative bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl overflow-hidden border-2 border-blue-200/50">
        ...
        <div className="mt-20 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="text-5xl font-black text-indigo-600 mb-2">2000+</div>
          ...
          <div className="relative inline-block">
            ...
            <div className="relative bg-gradient-to-r from-blue-500 to-indigo-500 rounded-3xl shadow-2xl p-12 text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="/contact"
                  className="px-10 py-4 bg-white text-blue-600 font-bold rounded-2xl hover:bg-blue-50 transition-all duration-300 hover:shadow-xl hover:scale-105"
                >
                  Start Your Journey →
                </a>
                <a
                  href="/courses"
                  className="px-10 py-4 bg-blue-600 text-white font-bold rounded-2xl hover:bg-blue-700 transition-all duration-300 hover:shadow-xl hover:scale-105 border-2 border-blue-400"
                >
                  Explore Courses 🎓
                </a>
              </div>
