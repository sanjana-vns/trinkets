...
const CourseCategories = () => {
  ...
  const courses = [
    ...
    },
    {
      ...
      rating: 4.6,
      students: 420,
      features: ["2D & 3D Design", "Infrastructure Projects", "Precise Modeling", "File Compatibility"],
      image: "📐",
    ...
    },
    {
      ...
      rating: 4.8,
      students: 320,
      features: ["BIM Software", "3D Structural Modeling", "Detailing", "Construction Workflows"],
      image: "🏗️",
    ...
    {
      id: 18,
      title: "AutoCAD Piping",
      category: "Software Courses",
      duration: "2 months",
      level: "Intermediate",
      rating: 4.5,
      students: 650,
      features: ["Piping Systems Design", "Detailed Layouts", "Industrial Projects", "Complex Systems"],
      image: "🔧",
      gradient: "from-blue-600 to-indigo-600",
      badge: "Industry Standard",
    ...
    },
    {
      ...
      rating: 4.7,
      students: 780,
      features: ["Civil Infrastructure", "Terrain Modeling", "Road Planning", "Site Development"],
      image: "🛣️",
    ...
    },
    {
      ...
      rating: 4.6,
      students: 540,
      features: ["Electrical Control Systems", "Automated Wiring", "Numbering", "Report Generation"],
      image: "⚡",
      gradient: "from-yellow-600 to-orange-600",
    ...
    },
    {
      ...
      rating: 4.5,
      students: 390,
      features: ["HVAC System Design", "Installation Drawings", "Maintenance Plans", "Building Systems"],
      image: "❄️",
      gradient: "from-sky-600 to-blue-600",
    ...
    },
    {
      ...
      rating: 4.7,
      students: 480,
      features: ["3D Modeling", "Animation", "Realistic Visuals", "Architectural Rendering"],
      image: "🎨",
    ...
    },
    {
      ...
      rating: 4.8,
      students: 280,
      features: ["Plant Design", "Real-time Collaboration", "Integration", "Code Compliance"],
      image: "🏭",
      gradient: "from-indigo-600 to-purple-600",
      badge: "Plant Design",
    ...
    },
    {
      ...
      rating: 4.6,
      students: 360,
      features: ["Programming", "Data Analysis", "Simulation", "Advanced Tools"],
      image: "📊",
      gradient: "from-orange-600 to-red-600",
      badge: "Data Science",
      link: "/courses/matlab"
