            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12">
              <div className="space-y-8 animate-slideUp">
                <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-2xl border border-indigo-200 hover:shadow-xl transition-all duration-300">
                  ...
                  <p className="text-gray-700 mb-6">MEP engineering encompasses the design and integration of HVAC, electrical, and plumbing systems, ensuring buildings are functional, safe, and energy-efficient. Mumbai’s skyline, with projects like high-rises, metro systems, and commercial complexes, relies on skilled MEP engineers. TIT’s <Link href="https://titindia.com/courses/mep-engineering-course-in-mumbai/" className="font-bold text-blue-700 hover:text-blue-900 hover:underline">MEP Engineering Course in Mumbai</Link> trains you to create efficient, code-compliant designs using industry-standard tools, positioning you as a top candidate for firms like Voltas, Blue Star, and L&T Construction.</p>
                  <h4 className="text-xl font-bold text-gray-900 mb-4">Mumbai’s Construction Advantage</h4>
                  <p className="text-gray-700">Mumbai’s role as a construction and engineering epicenter makes it perfect for an <Link href="https://titindia.com/courses/mep-engineering-course-in-mumbai/" className="font-bold text-blue-700 hover:text-blue-900 hover:underline">MEP Engineering Course in Mumbai</Link>. TIT’s Mulund campus connects you to this vibrant ecosystem, offering hands-on exposure and access to high-demand job markets. From smart cities to sustainable buildings, Mumbai provides the perfect backdrop for mastering MEP engineering.</p>
                </div>
              </div>
