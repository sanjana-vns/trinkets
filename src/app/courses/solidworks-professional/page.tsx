        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
              <h3 className="text-lg font-semibold text-teal-600 mb-3">AutoCAD Mechanical Design</h3>
              <p className="text-gray-600 mb-4 text-sm">Master 2D/3D design, Inventor, SolidWorks for manufacturing industry.</p>
              <Link href="/courses/autocad-mechanical-design" className="text-teal-600 hover:text-teal-800 font-medium">
                Learn More →
              </Link>
            </div>
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
